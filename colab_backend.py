# =============================================================================
# Google Colab Backend - AI Prompt Optimizer (FastAPI + ngrok)
# Run this entire file in a Google Colab code cell
# =============================================================================

# --- Install dependencies ---
import subprocess
subprocess.run(["pip", "install", "fastapi", "uvicorn", "pyngrok", "spacy", "nltk", "scikit-learn", "nest-asyncio", "-q"])
...
def optimize(req: PromptRequest):
    ...
    # Generic AI answer (placeholder — can be replaced with actual LLM call)
    answer = (
...
# Set your ngrok auth token here (get it from https://dashboard.ngrok.com/get-started/your-authtoken)
# ngrok.set_auth_token("YOUR_NGROK_AUTH_TOKEN")  # Uncomment and replace with your token

# Start ngrok tunnel
public_url = ngrok.connect(8000)
print(f"\n🚀 Backend API is live at: {public_url}")
print(f"📡 API Docs: {public_url}/docs")
print(f"💡 Use this URL in your React frontend\n")

# Apply nest_asyncio so uvicorn runs in Colab
nest_asyncio.apply()
